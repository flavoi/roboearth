...
(cl:defmethod cl:initialize-instance :after ((m <File>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'File)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name re_msgs-msg:<File> is deprecated: use re_msgs-msg:File instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <File>))
